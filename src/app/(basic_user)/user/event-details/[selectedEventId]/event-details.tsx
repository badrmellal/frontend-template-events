                ...
                <div className="mt-4 flex space-x-4">
                  ...
                  {event.publisherSocialLinks?.facebook && (
                    <Link href={event.publisherSocialLinks.facebook} target="_blank" rel="noopener noreferrer">
                      <FaFacebook className="h-6 w-6 text-blue-500 hover:text-blue-400" />
                    </Link>
                  )}
                ...
                <div className="flex space-x-4">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="bg-gray-900 border-gray-700">
                      <DropdownMenuLabel className="text-white">Social Media</DropdownMenuLabel>
                      <DropdownMenuSeparator className="bg-gray-700" />
                      <DropdownMenuItem className="text-white hover:bg-gray-800">Facebook</DropdownMenuItem>
                      <DropdownMenuItem className="text-white hover:bg-gray-800">Twitter</DropdownMenuItem>
                      <DropdownMenuItem className="text-white hover:bg-gray-800">Instagram</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </div>
              </CardContent>
